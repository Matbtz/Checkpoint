...
export const VerticalGameCard = memo(function VerticalGameCard({
    ...
    const coverImage = item.customCoverImage || game.coverImage || '/placeholder.png';
    ...
    return (
        <motion.div
            ...
            className={cn(
                "group relative w-full aspect-[2/3] overflow-hidden rounded-lg bg-zinc-900 shadow-md cursor-pointer",
        ...
        >
            ...
            {/* Title Overlay */}
            <div className="absolute top-0 left-0 right-0 p-2 bg-gradient-to-b from-black/80 to-transparent pointer-events-none">
                <h3 className="text-xs font-bold text-white text-center leading-tight drop-shadow-md line-clamp-2">
                    {game.title}
                </h3>
            </div>
