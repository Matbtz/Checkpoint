    ...
    >
      ...
      <div className="absolute inset-0 z-0 select-none">
        <Image
          ...
          priority={false}
        />
        <div className="absolute inset-0 bg-[linear-gradient(90deg,transparent_0%,transparent_15%,rgba(9,9,11,0.6)_30%,#09090b_45%,#09090b_55%,rgba(9,9,11,0.6)_70%,transparent_85%,transparent_100%)] z-10" />
      </div>
