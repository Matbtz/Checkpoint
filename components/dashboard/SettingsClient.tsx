...
export default function SettingsClient({ initialPace, initialTags, initialAccounts, userSteamId, initialPlatforms }: SettingsProps) {
    ...
    return (
        <div className="container mx-auto py-8 px-4 max-w-2xl space-y-12">
            ...
            {/* Platforms Section */}
            <section className="space-y-4">
                <h2 className="text-xl font-semibold">Platforms Owned</h2>
                <p className="text-zinc-500 text-sm">
                    Platforms you own and where you want to follow games. This will filter recommendations on the homepage.
                </p>
                <div className="bg-white dark:bg-zinc-900 p-6 rounded-lg border border-zinc-200 dark:border-zinc-800 space-y-6">
